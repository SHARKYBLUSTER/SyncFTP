...
def load_config():
    ...
    default_config = {
        ...
        'exclude_patterns': '*.tmp,*.part,*.temp,*.~lk,*.lock,Thumbs.db,desktop.ini,.github/,.stfolder/,.env',  # Patterns à exclure
    ...
    try:
        ...
        if 'exclude_patterns' not in config:
            config['exclude_patterns'] = '*.tmp,*.part,*.temp,*.~lk,*.lock,Thumbs.db,desktop.ini,.github/,.stfolder/,.env'
            save_config(config)
